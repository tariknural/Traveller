...
public class GonderiSikayet {

    private Integer id;
    private Integer sikayetEdilenGonderiId;
	...
	public Integer getSikayetEdilenGonderiId() {
		return sikayetEdilenGonderiId;
	}

	public void setSikayetEdilenGonderiId(Integer sikayetEdilenGonderiId) {
		this.sikayetEdilenGonderiId = sikayetEdilenGonderiId;
	}
